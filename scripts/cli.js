...
const contractABI = require("../artifacts/contracts/Distilwhisper.sol/Distilwhisper.json").abi;

program
    .name("distilwhisper-cli")
    .description("CLI tool for Distilwhisper smart contract")
    .version("1.0.0");
